...
public class BPlusTree<T extends Comparable<T>, V> {
    ...
    public void BPlusTree(int factor) {
        this.factor = factor;
     ...
     * @param <V>
     */
    abstract static class Node<T extends Comparable<T>, V> {
    ...
    public static void main(String[] args) {
        BPlusTree<Integer, String> myTree = new BPlusTree<Integer, String>();
        int max = 1000000;
